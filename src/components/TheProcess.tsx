    ...
    <section ref={ref} className={styles.processSection}>
      <div className={styles.container}>
        ...
        >
              ...
              <div className={styles.cardImage}>
                ...
                <div className={styles.techLogosContainer}>
                  <div className={styles.techLogos}>
                    <div className={`${styles.techLogo} ${styles.html}`}>
                    ...
                    <div className={`${styles.techLogo} ${styles.css}`}>
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className={`${styles.techLogo} ${styles.js}`}>
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className={`${styles.techLogo} ${styles.react}`}>
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className={`${styles.techLogo} ${styles.node}`}>
          ...
          {/* Process Card 2 - Interactive Code Tabs */}
          <motion.div 
            className={styles.processCard}
            variants={itemVariants}
            whileHover={shouldReduceMotion ? {} : { y: -5, transition: { duration: 0.2 } }}
          >
            <div className={styles.cardImageContainer}>
              <div className={styles.cardImage}>
                {/* Interactive code editor with tabs */}
                    ...
                    >
                      ...
                      <TabsContent value="html" className={styles.codeContent}>
                        ...
                        <div className={styles.codeText}>
                          <pre>{codeExamples.html}</pre>
                        </div>
                      </TabsContent>
                      <TabsContent value="nextjs" className={styles.codeContent}>
                        <div className={styles.lineNumbers}>
          ...
          {/* Process Card 3 - Hover Card with Metrics */}
          <motion.div 
            className={styles.processCard}
            variants={itemVariants}
          >
            <HoverCard>
              <HoverCardTrigger asChild>
                <div className={`${styles.cardImageContainer} ${styles.scrollableContainer}`}>
                  <div className={styles.cardImage}>
                    {/* Analytics dashboard that scrolls on hover */}
                    <div className={styles.dashboard}>
                      <div className={styles.metricsContainer}>
                        ...
                        <div className={styles.hiddenMetric}>

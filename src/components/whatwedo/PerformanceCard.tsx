  ...
  return (
    <div className={`${styles.showcaseCard} transform-none`}>
      ...
      <div className="flex flex-col items-center text-center px-5 md:px-8 pt-10 pb-8 relative z-10 h-full">
        <h3 className="text-2xl md:text-3xl mb-3 font-bold font-comfortaa">Engineered for Performance</h3>
        <p className="text-gray-600 text-sm md:text-base mb-6 max-w-lg font-baloo">
        ...
        <Button
          ...
          size="default"
          asChild
          className="mb-8 border border-gray-200 rounded-full font-baloo hover:bg-gray-50"
        >
        ...
        <BrowserWindow>
          <div className="p-4 md:p-6 bg-white">
            <div className="pb-4 md:pb-6">
              <h4 className="text-sm md:text-base font-medium mb-4 text-gray-800 font-baloo">Report from May 5, 2025</h4>
              <div className="flex space-x-2 items-center mb-4">
                <div className="flex-grow relative">
                  ...
                  />
                  <button className="absolute right-1 top-1 bottom-1 px-3 bg-blue-500 rounded-md text-white text-xs font-baloo hover:bg-blue-600 transition-colors">
                    Analyze
                  </button>
                </div>
              </div>
            ...
            <div>
              <h5 className="text-sm font-medium mb-5 text-gray-700 font-baloo">Performance metrics</h5>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
                {metrics.map((metric) => (
                  <div key={metric.name} className="flex flex-col items-center">
                    ...
                    <span className="text-xs text-gray-600 font-baloo">{metric.name}</span>
                  </div>
                ))}
              </div>
            </div>
